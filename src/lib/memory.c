...
void *lox_realloc( void *mem, size_t new_size,
                  size_t old_size, struct memory_tracker *tracker) {
...
void *lox_reallocarray( void *mem, size_t nmemb,
                       size_t old_nmemb, size_t size, struct memory_tracker *tracker) {
